...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  //add major earthquakes to the map, using a D3 json call
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  let tectplate = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
  d3.json(tectplate).then((data) => {
    console.log(data);
    L.geoJson(data, {
